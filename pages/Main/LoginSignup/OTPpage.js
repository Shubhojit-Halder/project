        ...
        <div className={styles.mainDiv}>
          <div className={styles.inputs_login}>
                ...
                <div className={styles.design}>
                  ...
                  <Box sx={{ "& > :not(style)": { ml: 2 } }}>
                    ...
                    <div className={styles.signupBtnDiv}>
                      <Button className={styles.sendOTPBTN}>Send OTP</Button>
                      <Link href={"/"}>
                        <Button
            ...
            <div className={styles.sidePara}>
              ...
              <p>
                We're here to give you a better social media experience where
                you can learn and grow without losing a single bit of fun.
              </p>
            </div>
          </div>
        </div>
